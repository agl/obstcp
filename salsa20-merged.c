...
void ECRYPT_keysetup(struct ECRYPT_ctx *x,const u8 *k,u32 kbits,u32 ivbits)
{
...
void ECRYPT_ivsetup(struct ECRYPT_ctx *x,const u8 *iv)
{
...
void ECRYPT_encrypt_bytes(struct ECRYPT_ctx *x,const u8 *m,u8 *c,u32 bytes)
{
